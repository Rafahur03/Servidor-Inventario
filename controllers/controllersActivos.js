...
const crearActivo = async (req, res) => {
    ...
    try {
        ...
        actividadUsuario(sessionid, 'Crea el activo' + nuevoActivo.id, ipAddress)
    } catch (error) {

        console.log('desde crear Activo ' + error)
...
const actualizarActivo = async (req, res) => {
    ...
    const ipAddress = req.connection.remoteAddress.split('f:')[1]
    actividadUsuario(sessionid, 'Actualzia activo ' + activo.id, ipAddress)
...
const cambiarClasificacion = async (req, res) => {
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Cambia clasificacion activo' + data.id + ' de ' + datafile.siglaAntigua + ' a ' + datafile.siglaNueva, ipAddress)
    } catch (error) {
        console.log('desde cambiar classification' + error)
    }
}
...
const eliminarActivo = async (req, res) => {
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Elimina el activo' + data.id, ipAddress)
    } catch (error) {
        console.log('desde cambiar classification' + error)
    }
}
...
const guardarImagenActivo = async (req, res) => {
    ...
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Guardar Imagen Activo' + data.id, ipAddress)
    } catch (error) {
        console.log('Guardar Imagen Activo ' + error)
    }
...
const eliminarImagenActivo = async (req, res) => {
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, '>Eliminar Imagen Activo' + data.id, ipAddress)
    } catch (error) {
        console.log('eliminar Imagen Activo ' + error)
    }
}
...
const eliminarDocumento = async (req, res) => {
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Eliminar documento ' + nombre + ' del Activo ' + data.id, ipAddress)
    } catch (error) {
        console.log('Eliminar documento activo' + error)
    }
}
...
const descargarDocumento = async (req, res) => {
    ...
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Descargar documento ' + data.documento + ' del Activo ' + data.id, ipAddress)
    } catch (error) {
        console.log('Descargar documento activo' + error)
    }
}
...
const guardarDocumento = async (req, res) => {
    ...
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Guardar documento ' + data.documento + ' del Activo ' + data.id, ipAddress)
    } catch (error) {
        console.log('Guardar documento activo' + error)
    }
...
const descargarHojaDeVida = async (req, res) => {
    ...
    try {
        ...
        const ipAddress = req.connection.remoteAddress.split('f:')[1]
        actividadUsuario(sessionid, 'Descargar Hoja de vida Activo' + data.id, ipAddress)

    } catch (error) {
        console.log('Descargar HV activo' + error)
